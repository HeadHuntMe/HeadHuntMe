						  ...
						  <div class="pro-section project-details">
						   ...
						   <div class="fr-project-bidding proposals-dashboard only-proposals">
									<?php
													...
													<div class="fr-project-profile">
													  <div class="fr-project-profile-details">
														...
														<div class="fr-project-content-details">
                                                           ...
                                                           <?php 
                                                              if(fl_framework_get_options('allow_projects_offers')){
                                                                   ?>
                                                                 <button type="button" class="btn btn-theme-secondary btn-loading send_offer" id="send_offer" data-pid="<?php echo esc_attr($project_id); ?>" data-fl-id="<?php echo esc_attr($result->freelancer_id); ?>"  prop_id = <?php echo $proposal_id; ?> > <?php echo esc_html__( 'Send Offer', 'exertio_theme' ); ?> <div class="bubbles"> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> <i class="fa fa-circle"></i> </div></button>
                                                            <?php
                                                              }
                                        ...
                                        if (fl_framework_get_options('enable_sb_chat_on_project') == true) {

                                            if (class_exists('SB_Chat')) {
                                                $classes = 'btn btn-theme-secondary btn-loading';
                                                 $button_title  =  esc_html__('Send Message','exertio_theme');

                                                echo do_shortcode('[sb_chat_shortcode_popup 
                                                     class = "'.$classes.'"
                                                     button_title = "'.$button_title.'"
                                                    post_id="' . $freelancer_user_id . '"  post_author_id="' . $freelancer_user_id . '" ]');
