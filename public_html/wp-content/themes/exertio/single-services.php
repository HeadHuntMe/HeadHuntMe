...
if ( isset($exertio_theme_options[ 'action_bar' ]) && $exertio_theme_options[ 'action_bar' ] == 1 ) {
        ...
        <div class="fr-seller-servives-2" id="seller">
          <div class="fr-seller-servives">
            ...
            <div class="fr-seller-servives-meta"> <?php  echo $profile_clickable; ?>
              ...
              <div class="fr-seller-view <?php echo $none; ?>"> <a href="<?php  echo esc_url(get_permalink($fid)); ?>" class="btn btn-theme"><?php echo esc_html__('View Profile','exertio_theme'); ?></a> </div>
            </div>
          </div>
...
if( fl_framework_get_options('enable_sb_chat_on_services') == true)
      {
          ...
          $classes = 'btn btn-theme';
           ...
           $button_text  =  __('Chat with Seller' , 'exertio_theme');
